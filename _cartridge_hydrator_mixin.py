...
class CartridgeHydratorMixin:
    ...
    def _hydrate_internal_structures(self):
        ...
        print(f"Hydrated {len(self.modules)} modules, {len(self.resources)} resources, {len(self.wiki_pages)} wiki pages, {len(self.announcements)} discussions, {len(self.assignments)} assignments, {len(self.files)} files")
